...
describe('AstTranslator', () => {
  describe('Expressions', () => {
    ...
    it('translates ReadKeyExpr', () => {
      const expr = new o.ReadKeyExpr(new o.ReadVarExpr('arr'), new o.LiteralExpr(0));
    ...
    it('translates UnaryOperatorExpr', () => {
      const minus = new o.UnaryOperatorExpr(o.UnaryOperator.Minus, new o.ReadVarExpr('x'));
      const plus = new o.UnaryOperatorExpr(o.UnaryOperator.Plus, new o.ReadVarExpr('x'));
    ...
    it('translates InvokeFunctionExpr', () => {
      const expr = new o.InvokeFunctionExpr(
        new o.ReadVarExpr('fn'),
        [new o.LiteralExpr(1), new o.LiteralExpr(2)]
      );
      expect(printExpr(expr)).toBe('fn(1, 2)');
    });

    it('translates InstantiateExpr', () => {
      const expr = new o.InstantiateExpr(
        new o.ReadVarExpr('Foo'),
    ...
    it('translates FunctionExpr', () => {
      const expr = new o.FunctionExpr(
        ...
        [new o.ReturnStatement(new o.BinaryOperatorExpr(
          o.BinaryOperator.Plus,
          new o.ReadVarExpr('x'),
          new o.ReadVarExpr('y')
        ))]
    ...
    it('translates ArrowFunctionExpr with expression body', () => {
      const expr = new o.ArrowFunctionExpr(
        [{ name: 'x' } as any],
        new o.BinaryOperatorExpr(o.BinaryOperator.Multiply, new o.ReadVarExpr('x'), new o.LiteralExpr(2))
      );
      const result = printExpr(expr);
    ...
    it('translates ArrowFunctionExpr with statement body', () => {
      const expr = new o.ArrowFunctionExpr(
        [{ name: 'x' } as any],
        [new o.ReturnStatement(new o.ReadVarExpr('x'))] as any
      );
      const result = printExpr(expr);
      expect(result).toContain('=>');
      expect(result).toContain('return');
    ...
    it('translates ParenthesizedExpr', () => {
      const expr = new o.ParenthesizedExpr(new o.BinaryOperatorExpr(
        o.BinaryOperator.Plus,
        new o.LiteralExpr(1),
        new o.LiteralExpr(2)
      ));
    ...
    it('translates ExternalExpr for @angular/core', () => {
      const expr = new o.ExternalExpr({ name: 'ɵɵdefineComponent', moduleName: '@angular/core' });
    ...
    it('translates i18n LocalizedString throws', () => {
      ...
      expect(() => {
        const fakeAst = { visitExpression: (v: any, c: any) => (v as any).visitLocalizedString(fakeAst, c) };
  ...
  describe('Statements', () => {
    it('translates DeclareVarStmt with const', () => {
      const stmt = new o.DeclareVarStmt('x', new o.LiteralExpr(42), undefined, o.StmtModifier.Final);
    ...
    it('translates DeclareFunctionStmt', () => {
      const stmt = new o.DeclareFunctionStmt(
        ...
        [new o.ReturnStatement(
          new o.BinaryOperatorExpr(o.BinaryOperator.Plus, new o.ReadVarExpr('a'), new o.ReadVarExpr('b'))
        )]
      );
      const result = printStmt(stmt);
